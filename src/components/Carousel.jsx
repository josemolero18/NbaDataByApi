...
export const Carousel = () => {
  return (
    <div id="carouselExampleDark" className="carousel carousel-dark slide mt-3 rounded w-100">
      ...
      <div className="carousel-inner">
        <div className="carousel-item active" data-bs-interval="10000">
          <div className="d-block w-100">
            <img src={wembiImage} className="d-block rounded w-100 mx-auto animate__animated animate__slideInDown" alt="..." style={{
        ...
        <div className="carousel-item" data-bs-interval="2000">
          <img src={twinsImage} className="d-block rounded w-100 animate__animated animate__slideInLeft" alt="..." style={{
              background: 'linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5))',
              opacity: 0.9,
            }}/>
          <div className="carousel-caption d-none d-md-block">
        ...
        <div className="carousel-item">
          <img src={hardenImage} className="d-block rounded w-100 rounded animate__animated animate__slideInRight" alt="..." style={{
              background: 'linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5))',
              opacity: 0.9,
            }}
